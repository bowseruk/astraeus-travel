...
function About() {
    return (
        ...
        <section className="aboutPage">
            ...
            <div className="container5">
                <figure><img src="/src/assets/images/blackhole.png" width="1000" height="750" alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="container5">
                <figure><img src="/src/assets/images/stsci-h-p1943a-f-2076x1484 (1).png" width="1000" height="750" alt="Shoes" /></figure>
                <div className="card-body">
            ...
            <div className="container5">
                <figure><img src="/src/assets/images/main_image_star-forming_region_carina_nircam_final-5mb.jpg" width="1000" height="750" alt="Shoes" /></figure>
                <div className="card-body">
